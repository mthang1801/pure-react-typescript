...
export const API_USER_SYSTEM = "user-systems";
export const API_PACKAGES = "service-packages";

export const API_USER_GROUPS = "roles";
...
export const API_INVENTORY = "inventory-receipts";
...
//========= LOCATORS ===========//
export const API_PROVINCES = "provinces";
export const API_DISTRICTS = "districts";
export const API_WARDS = "wards";
export const API_BILL = "orders/deliveries";
export const API_COD = "cod-and-carriage-bills";
export const API_CONFIGS = "general-settings";
